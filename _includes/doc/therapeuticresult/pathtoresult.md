...
Ещё одной проблемой этой точки может оказаться то, что клиент не владеет "_словарём эмоций_", у него нет навыков использования тезауруса описания переживаемых состояний и практики мимической демострации отклика.
