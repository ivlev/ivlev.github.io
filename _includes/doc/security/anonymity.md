...
Часть метаданных транслируется клиентом сознательно, в форме временных маркеров и контекстных описаний обстоятельств психотравмирующих событий. Терапевт задает вопросы и получает вербальные ответы. По различным оценкам таким методом можно получить 15-20% информации необходимой для работы с проблемой. Дополнительный объем информации получается по невербальным (_не аккустическим_) каналам.  
