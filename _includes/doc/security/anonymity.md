...
- связывваться через сервисы скрывающие сетевые и аппаратные адреса оборудования;
- при необходдимости передачи терапевту статической информации (фотографии, видео, документы и т.п.) 
