...
Часть метаданных транслируется клиентом **сознательно**, в форме _временных маркеров и контекстных описаний обстоятельств_ психотравмирующих событий. Терапевт задает вопросы и получает **вербальные ответы**. Значитеьная составляющая в получаемой таким образом информации - интонация и эмоционалная окраска описаний. По различным оценкам таким методом можно получить **15-20%** информации необходимой для работы с проблемой. Дополнительный объем информации получается по **невербальным** (_не аккустическим_) каналам. В процессе сессии клиент **не осознанно** транслирует метаданные в визульном канале: жесты, мимика, напряженность позы.
