...
Рабочие сеансы _атомарные_, _не делимые_, проводятся **дистанционно**. Длительность сеанса **не превышает 60 минут**, заканчивается фразой "*Конец сеанса*" и может быть **короче по инициативе клиента**. 

**Первый** (_инициализирующий_) **сеанс** возможен **только один раз**. Он проводится _анонимно, без взаимных обязательств, по личному запросу клиента_ через специальную форму гарантирующую **шифрование сообщения на стороне запроса**. Инициатор сам выбирает время и способ проведения *первого* сеанса: обмен сообщениями по _электронной почте, в месседжерах, чатах или видеосвязи_.
