...
Рабочие сеансы _атомарные_, _не делимые_ акты терапии, проводятся **дистанционно**. Длительность сеанса **не превышает 60 минут**. Сеанс заканчивается фразой "*Конец сеанса*" и может быть **короче по инициативе клиента**. 
