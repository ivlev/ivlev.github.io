...
Не даются консультации по **преднамеренному обману**, **сокрытию преступной деятельности** и **поощряющие корпоративные манипуляции**, целью которых является получение карьерной выгоды в ущерб коллегам по работе.
...
Терапия строится вокруг **безопасности клиента, его близких и окружения**.  
