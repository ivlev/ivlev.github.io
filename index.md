...
**Первый** (_инициализирующий_) **сеанс** возможен **только один раз**. Он _анонимный, без взаимных обязательств, по личному запросу клиента_ через специальную форму гарантирующую **шифрование сообщения на стороне клиента**. Инициатор предлагает **время** и **технику** проведения *первого* сеанса: обмен сообщениями по _электронной почте, в месседжерах, чатах или видеосвязи_.
...
Оплата принимается в **фиатных** и **не фиатных** (_крипто_) валютах. **Выбор валюты - право клиента**. Кросс-курсы **фиксируются** на момент выставления счета. Для депозитов курс **фиксируется на момент внесения** средств на счет терапевта, если оплата проведена **до первого состоявшегося** платного сеанса.
