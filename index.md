...
**Первый** (_инициализирующий_) **сеанс** проводится _анонимно, без взаимных обязательств, по личному запросу клиента_ через специальную форму гарантирующую **шифрование сообщения на стороне запроса**. Инициатор сам выбирает время и способ проведения сеанса: обмен сообщениями по _электронной почте, в месседжерах, чатах или видеосвязи_.
